...
This README will walk you through how to start using EMake for your
project and will get you up and running with the appropriate version
of Emacs installed on your favorite CI provider.
